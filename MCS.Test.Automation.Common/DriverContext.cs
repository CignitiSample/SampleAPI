...
#pragma warning restore SA1201 // Elements must appear in the correct order
        ...
        public string ExtentReportOutBinFolder
        {
            get
            {
                DirectoryInfo direc = Directory.GetParent(this.CurrentDirectory).Parent.Parent;
                string dirPath = direc.FullName;
                return FilesHelper.GetFolder(BaseConfiguration.ExtentReportOutBinFolder, dirPath);
            }
        }
        ...
        private FirefoxOptions FirefoxOptions
        {
            get
            {
                ...
                options.SetPreference("browser.helperApps.neverAsk.saveToDisk", "application/vnd.ms-excel, application/x-msexcel, application/pdf, application/doc, text/csv, text/html, application/octet-stream");
                options.SetPreference("browser.helperApps.neverAsk.openFile", "application/pdf, application/octet-stream, application/x-winzip, application/x-pdf, application/x-gzip");
        ...
        public void Start(BrowserType browserType, bool setAutoDownload = false)
        {
            switch (browserType)
            {
                ...
                case BrowserType.IE:
                    ...
                    //startInfo.Arguments = "taskkill //f //im IEDriverServer.exe";
        ...
        public string[] TakeAndSaveScreenshot()
        {
            ...
            try
            {
                ...
                {
                    string imgpath = TakeScreenShot.Save(TakeScreenShot.DoIt(), ImageFormat.Png, this.ScreenShotFolder, this.TestTitle);
                    if (imgpath != null)
                    {
