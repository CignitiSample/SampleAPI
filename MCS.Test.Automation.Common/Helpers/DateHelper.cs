...
namespace MCS.Test.Automation.Common.Helpers
{
    ...
    public static class DateHelper
    {
        ...
        /// The tomorrow date.
        /// </value>
        public static string TomorrowDateInMMDDYYYY
        {
            get
            {
                return DateTime.Now.AddDays(1).ToString("MMddyyyy", CultureInfo.CurrentCulture);
            }
        }
        ...
        public static string CurrentDateTimeZoneStamp
        {
            get
            {
                return DateTime.UtcNow.ToString("yyyy-MM-ddTHH\\:mm\\:ss", CultureInfo.CurrentCulture);
            }
        }
        ...
        /// The Previous date.
        /// </value>
        public static string PreviousDateInMMDDYYYY
        {
            get
            {
                return DateTime.Now.AddDays(-1).ToString("MM-dd-yyyy", CultureInfo.CurrentCulture);
        ...
        /// The current date.
        /// </value>
        public static string CurrentDateInMMDDYYYY
        {
            get
            {
                return DateTime.Now.ToString("MM-dd-yyyy", CultureInfo.CurrentCulture);
            }
        }
        ...
        public static string GetFutureDateInMMDDYYYY(int numberDaysToAddToNow)
        {
            return DateTime.Now.AddDays(numberDaysToAddToNow).ToString("MM-dd-yyyy", CultureInfo.CurrentCulture);
        }
        ...
        public static int RandomYearInteger()
        {
            int _min = 2020;
            int _max = 2050;
            Random _rdm = new Random();
