...
namespace MCS.Test.Automation.Common
{
    ...
    public static class BaseConfiguration
    {
        ...
        {
            get { return ConfigurationManager.AppSettings["SendEmail"]; }
        }
        ...
        public static string ExtentReportOutBinFolder
        {
            get { return ConfigurationManager.AppSettings["ExtentReportFolderOutBin"]; }
        }
        ...
        /// <summary>
        /// Gets the condition to save the report outside the bin folder or inside.
        /// </summary>
        public static string ReportOutsideBin
        {
            get { return ConfigurationManager.AppSettings["ReportOutsideBin"]; }
        }
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        /// <summary>
        /// Gets the MCS2 QA application host name.
        /// </summary>
        ...
        /// Gets the MCS2 QA application host name.
        /// </summary>
        public static string MCS2ASTMInternalhost
        {
            get
            {
                string env = ConfigurationManager.AppSettings["TestENV"];
                ...
                if (testEnv == "QA")
                {
                    return ConfigurationManager.AppSettings["QAMCS2ASTMInternalhost"];
                }
                else if (testEnv == "PROD")
                {
                    return ConfigurationManager.AppSettings["PRODMCS2host"];
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        /// <summary>
        /// Gets the username for Rules and Exceptions application
        /// </summary>
        public static string UsernameRnE
        {
            get { return ConfigurationManager.AppSettings["usernameRnE"]; }
        }

        /// <summary>
        /// Gets the password for Rules and Exceptions application
        /// </summary>
        public static string PasswordRnE
        {
            get { return ConfigurationManager.AppSettings["passwordRnE"]; }
        }

        /// <summary>
        /// Gets the username for Internal application
        /// </summary>
        public static string usernameInternalApp
        {
            get { return ConfigurationManager.AppSettings["usernameInternalApp"]; }
        }

        /// <summary>
        /// Gets the password  for Internal application
        /// </summary>
        public static string PasswordInternalapp
        {
            get { return ConfigurationManager.AppSettings["passwordInternalApp"]; }
        }
        ...
        /// var url = BaseConfiguration.GetUrlValue;
        /// </code></example>
        public static string GetMCS2ASTMInternalUrlValue
        {
            get
            {
                return string.Format(CultureInfo.CurrentCulture, "{0}://{1}{2}", Protocol, MCS2ASTMInternalhost, Url);
            }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings["SqlUserId"]; }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings["SqlDatabaseName"]; }
        }

        public static string SqlConnectionTimeOut
        {
            get { return ConfigurationManager.AppSettings["SqlConnectionTimeOut"]; }
        }

        public static string EmailSenderUserID
        {
            get { return ConfigurationManager.AppSettings["senderID"]; }
        }

        public static string EmailSenderPwd
        {
            get { return ConfigurationManager.AppSettings["senderPwd"]; }
        }
        public static string EmailReceiverUserID
        {
            get { return ConfigurationManager.AppSettings["receiverID"]; }
        }

        /// <summary>
        /// Gets the Email ID of the CC Person.
        /// </summary>
        public static string CcUserID
        {
            get { return ConfigurationManager.AppSettings["ccId"]; }
        }

        /// <summary>
        /// Gets the Confirmation status of the mail to send.
        /// </summary>
        public static string EmailStatus
        {
            get { return ConfigurationManager.AppSettings["EmailSendingStatus"]; }
        }
