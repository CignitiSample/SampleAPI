...
namespace APIIntegration
{
    public static class APIConnectivity
    {
        ...
        public static async Task RunAsync()
        {
            ...
            //string apiBaseAddress = "https://rtdb-astm-prod.azurewebsites.net/apiconnector/orderhistory";
            //string apiBaseAddress = "https://rtdb-astm-dev.azurewebsites.net/apiconnector/orderhistory";
            //string apiBaseAddress = "https://rtdb-astm-qa.azurewebsites.net/apiconnector/validateaddress";
            //string apiBaseAddress = "https://rtdb-astm-qa.azurewebsites.net/apiconnector/addorder";
            //string apiBaseAddress = "http://localhost:53832/apiconnector/validateaddress";
            string apiBaseAddress = "https://rtdb-astm-qa.azurewebsites.net/apiconnector/validateaddress";
            ...
            var jsonPayload = ValidateAddressApiPayload();
            // HttpResponseMessage response = await client.PostAsJsonAsync(apiBaseAddress, order);
            HttpResponseMessage response = await client.PostAsync(apiBaseAddress, new StringContent(jsonPayload, Encoding.UTF8, "application/json"));
